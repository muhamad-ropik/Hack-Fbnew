...
echo $i" |"$cy"     INDONESIA DARK CYBER ARMY"$i"           |"
echo $i" |"$me"─────────────────────────────────────────────"$i""
echo $i" |"$pu" AUTHOR :"$ku" MUHAMAD ROPIK  [MR.R021]"$i"  "
echo $i" |"$pu" CREATED :"$ku" MUHAMAD ROPIK"$i"            "
echo $i" |"$pu" THANKS TO :"$cy"~ [MR.R021] [MR.N17]  "$i"  "
echo $i" |"$pu" Contack WhatsApp :"$ku" 088213051360"$i"             "
echo $i" |"$pu" Contack Gmail :"$ku" muhamadropik8144@gmail.com"$i""
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
...
echo $i"────────────────────────────────    ─────"
echo
echo $me"┌==="$bi"["$i"ROPIK"$bi"]"$me"======"$bi"["$i""Pilih Nomornya""$bi"]"
echo $me"¦"
read -p"└──# " pil
...
sleep 2
echo $ku"WhatsApp :"$i" 088213051360"
echo $ku"Facebook :"$i" MUHAMAD ROPIK"
sleep 2
